...
#define ARMOR_INTERACTION_RANGE 5
#define EVO_INTERACTION_RANGE 5
#define HEALING_INTERACTION_RANGE 5

// BEACON THRESHOLDS
#define MONSTER_BEACON_CAPTURE_THRESHOLD -15.f
#define HUNTER_BEACON_CAPTURE_THRESHOLD 15.f
...
#define FIGHTER_ATTACK_DAMAGE 8
#define MAGE_ATTACK_DAMAGE 5
#define CLERIC_ATTACK_DAMAGE 5
#define ROGUE_ATTACK_DAMAGE 5
#define MONSTER_ATTACK_DAMAGE 5
...
#define ROGUE_ATTACK_DISTANCE 40
#define MAGE_ATTACK_DISTANCE 50
#define CLERIC_ATTACK_DISTANCE 30
...
#define MONSTER_RANGED_ATTACK_DISTANCE 50
